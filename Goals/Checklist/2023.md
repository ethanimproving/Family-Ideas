...
- [ ] Buy another Google Pixel (Storage doesn't matter, we have SD cards)
- [ ] Create itinerary on Digital Garden and send email.
- [ ] Create notes for Sermon Netflix idea.
...
- [x] Raise [Pull Request](https://github.com/Darakah/obsidian-timelines/pull/58) for frontmatter `support` in `obsidian-timelines`
	...
	- [ ] Notify [Issue 33](https://github.com/Darakah/obsidian-timelines/issues/33) in GitHub
